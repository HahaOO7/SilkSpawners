...
public class SilkSpawners extends JavaPlugin {
    ...
    private static final String[] COMPATIBLE_MINECRAFT_VERSIONS = { "v1_8_R3", "v1_11_R1", "v1_12_R1", "v1_13_R2", "v1_14_R1", "v1_15_R1",
            ...
            "v1_20_R2", "v1_20_R3", "v1_20_R4", "v1_21_R1", "v1_21_R2", "v1_21_R3", "v1_21_R4", "v1_21_R5", "v26_3" };
    ...
    public void onEnable() {
        ...
        if (!isEnabled()) {
            // SilkUtil could not find a handler for this version, already logged why and
            // called shutdown(). Bail out before registering anything on a disabled plugin,
